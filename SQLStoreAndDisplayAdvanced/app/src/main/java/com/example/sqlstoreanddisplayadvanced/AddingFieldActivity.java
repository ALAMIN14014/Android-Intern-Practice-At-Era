...
public class AddingFieldActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adding_field);
        pSaveInfo = findViewById(R.id.save_info_btn);
        pImageView = findViewById(R.id.person_image);
        pNameEt = findViewById(R.id.person_name);
        pAgeET = findViewById(R.id.person_age);
        pPhoneEt = findViewById(R.id.person_phone);
    ...
    private void getData() {
        ...
        String phone = ""+pPhoneEt.getText().toString().trim();

        String timeStamp = ""+System.currentTimeMillis();

        long id = dbHelper.insertInfo(name, age, phone, ""+imageUri, timeStamp, timeStamp);
        doToast("Record Added to id " + id);
    }
